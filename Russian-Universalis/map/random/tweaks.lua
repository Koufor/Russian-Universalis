...
RandomWorld = {
	...
	options = {
		width				= 2304,
		height				= 2304, -- STT
		overlapping_sea_province_search_width = 2304, -- Any sea province that overlaps with the randomized area needs to be removed from the provincemap, overlapping_sea_province_search_width is the rightmost edge of the area of the provincemap that will be searched for these provinces STT
	...
	heightmap = { -- Continents (fBm)
		min_water_height 	= 0.06, 	-- 15.0/255.0 STT
